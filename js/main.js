...
carbnum.addEventListener('keyup', event=>{
    ...
    elems.innerHTML =  carbchain;
        ...
        elems.innerHTML = `<div class="warning">Nomenclature kinda breaks down after 10 and dev isn't Heisenberg so don't! <br> <span> (Even Server won't allow after some point if I will let you do so) <span> </div>`
    }
